...
var CRM_CONST  = require('./href/crm_const_no'); // TOChange the default language shall be set 
...
function SessionHandler (db) {
    ...
    this.displayLoginPage = function(req, res, next) {
        ...
        var hcrm = { from: 'login',
        	        status:CRM_CONST.login_txt,
                 description:CRM_CONST.descLogin_txt};
        return res.render("login", {username:"", password:"", login_error:"feil", crmC: CRM_CONST, crm:hcrm})
    };
        ...
        users.validateLogin(username, password, function(err, user) {
            ...
            if (err) {
               ...
               if (err.no_such_user) {
                 ...
                 return res.render("login", {username:"", password:"", login_error:"No such user", crmC: CRM_CONST, crm:hcrm})
                 //return res.render("login", {username:username, password:"", login_error:"No such user"})
                }
                else if (err.invalid_password) {
                  console.log('invalid password');
                  return res.render("login", {username:"", password:"", login_error:"Innvalid password", crmC: CRM_CONST, crm:hcrm})           
                  //return res.render("login", {username:username, password:"", login_error:"Invalid error"});
                }
                else {
